...
const agenda = [
  {
    label: "Chatbot vs agente",
    detail: "Lo que vamos a ver hoy no es un chatbot, aunque lo parezca.",
  },
  {
    label: "Copilot Studio",
    detail:
      "Construir un agente con conocimiento real de la empresa, sin código, en vivo.",
  },
  {
    label: "Demo en Teams",
    detail:
      "El agente desplegado y funcionando con nuestro handbook corporativo.",
  },
  {
    label: "Cómo medir si funciona",
    detail:
      "Métricas reales para saber si la IA está ayudando o solo parece que ayuda.",
  },
];

export function HeroSectionCopilotStudio() {
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col px-6 py-24 lg:py-32">
        ...
        >
          La semana pasada vimos el mapa. Hoy damos el siguiente paso:
          construir un agente con conocimiento real de la empresa y aprender a
          saber si la IA está funcionando de verdad.
        </motion.p>
